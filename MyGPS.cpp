...
#ifndef _GPS_NO_STATS
void MyGPS::stats(unsigned long *chars, unsigned short *sentences, unsigned short *failed_cs)
{
...
/* static */
float MyGPS::distance_between (float lat1, float long1, float lat2, float long2) 
{
...
float MyGPS::course_to (float lat1, float long1, float lat2, float long2) 
{
...
const char *MyGPS::cardinal (float course)
{
...
void MyGPS::f_get_position(float *latitude, float *longitude, unsigned long *fix_age)
{
  long lat, lon;
